...
Plug 'mhartington/deoplete-github'
...
""" SEARCH
" Plug 'bronson/vim-visual-star-search'                " Don't jump to the next search, stay on current one
Plug 'google/vim-searchindex'
Plug 'haya14busa/incsearch.vim'                      " better incremental search, highlights in realtime everywhere as you type
" Plug 'henrik/vim-indexed-search'                     " Gives a count of the number of matches
